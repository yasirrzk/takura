  ...
  return (
    <div className="flex h-screen bg-slate-50 text-slate-900 font-sans selection:bg-indigo-100 selection:text-indigo-900 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <header className="h-20 bg-white/80 backdrop-blur-md border-b border-slate-200/60 flex items-center px-6 lg:px-8 justify-between z-10">
          <div className="flex items-center space-x-4">
            {/* Hamburger button visible only on mobile/tablet */}
            <button 
              onClick={openSidebar}
              className="lg:hidden text-slate-500 hover:text-slate-900 p-2.5 rounded-xl border border-slate-200 bg-slate-50/50 hover:bg-slate-50 transition-all cursor-pointer flex items-center justify-center"
            >
              <Menu size={18} />
            </button>
            ...
            <div className="relative group hidden sm:block">
              ...
              <input 
                type="text" 
                placeholder="Cari metrik, produk..." 
